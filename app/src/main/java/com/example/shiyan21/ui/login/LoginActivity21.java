...
public class LoginActivity21 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (flag){
                    Toast.makeText(LoginActivity21.this,"登陆成功",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(LoginActivity21.this, MainActivity.class);
                    intent.putExtra("author",account1);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(LoginActivity21.this, "用户名或密码错误",
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Toast.makeText(LoginActivity21.this,"创建成功！",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(LoginActivity21.this, MainActivity.class);
